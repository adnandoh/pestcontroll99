          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm sm:text-base ${errors.name ? 'border-red-300' : 'border-gray-300'
                  }`}
              />
              {errors.name && (
            ...
            <div>
              ...
              <input
                ...
                maxLength={10}
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm sm:text-base ${errors.phone ? 'border-red-300' : 'border-gray-300'
                  }`}
              />
              {errors.phone && (
            ...
            <div className="flex justify-center pt-4">
              <button
                ...
                className="bg-green-500 text-white py-4 px-8 rounded-lg font-bold hover:bg-green-600 transition-colors shadow-md hover:shadow-lg text-lg sm:text-xl disabled:bg-gray-400 disabled:cursor-not-allowed min-w-[250px] flex items-center justify-center"
              >
                {isSubmitting ? (
                  <>
