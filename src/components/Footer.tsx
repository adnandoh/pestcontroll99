        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-3">
              <a href="https://wa.me/9894966921?text=Hi%20PestControl99!%20I%20found%20you%20through%20your%20website%20and%20need%20pest%20control%20services." target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-600 transition-colors transform hover:scale-110">
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-600 text-sm">
              <div className="flex items-center">
                ...
                <a href="tel:+919894966921" className="hover:text-green-600 transition-colors">+91 98949 66921</a>
              </div>
              <div className="flex items-center">
                <svg className="w-4 h-4 mr-3 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
