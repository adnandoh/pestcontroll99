...
export default function Footer() {
  return (
    <footer className="text-gray-900 overflow-hidden">
      <div className="bg-gray-100 py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-gray-600 mb-4 text-sm leading-relaxed">
                <span className="font-bold text-gray-800">Multi pest care LLP</span> provides professional pest control services in Mumbai with 3+ years of experience. 100% safe, same-day service with 365-day warranty.
              </p>
              <div className="flex space-x-3">
                <a href="https://wa.me/7710032627?text=Hello%20Multi%20pest%20care%20LLP,%20can%20you%20share%20details%20and%20pricing%20for%20your%20pest%20control%20services?" target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-600 transition-colors transform hover:scale-110">
            ...
            <div>
              ...
              <div className="space-y-3 text-gray-600 text-sm">
                <div className="flex items-center">
                  ...
                  <a href="tel:+917710032627" className="hover:text-green-600 transition-colors">+91 77100 32627</a>
                </div>
                <div className="flex items-center">
                  <svg className="w-4 h-4 mr-3 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <a href="mailto:accounts@pestcontrol99.com" className="hover:text-green-600 transition-colors">accounts@pestcontrol99.com</a>
                </div>
                <div className="flex items-start">
                  ...
                  <span>1st Floor, Atlantic Tower B Wing, Aqsa Palace, 101, Gaothan Rd, next to Paneri Showroom, Andheri West, Mumbai, Maharashtra 400058</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-4 h-4 mr-3 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="border-t border-gray-200 mt-12 mb-8 opacity-20"></div>
        </div>
      </div>
