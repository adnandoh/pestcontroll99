  ...
  return (
    <Link href={href} className="block group">
      <div className="bg-white border-2 border-gray-100 rounded-2xl p-8 hover:shadow-lg hover:border-green-200 transition-all duration-150 relative overflow-hidden cursor-pointer">
        ...
        {/* CTA Button */}
        <div className="inline-flex items-center justify-center w-full bg-green-500 group-hover:bg-green-600 text-white py-4 px-6 rounded-xl font-semibold transition-colors duration-150">
          Learn More
