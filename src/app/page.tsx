...
export const metadata: Metadata = {
  ...
  description: "Professional pest control in Mumbai with 3+ years experience. Same-day service, 365-day warranty, eco-friendly treatments. Get instant quote for cockroach, mosquito, rodent control.",
  keywords: "pest control mumbai, same day pest control, cockroach control mumbai, mosquito control, rodent control, eco-friendly pest control, certified pest control mumbai",
  openGraph: {
    title: "Same-Day Pest Control Services in Mumbai | PestControl99",
    description: "Professional pest control with 365-day warranty. Same-day service, eco-friendly treatments, certified experts.",
    type: "website",
